const scenarios = [
    ...
    },
    {
        ...
        feedback_general: "On peut supposer que faire du vélo améliore directement la santé mais il y a au moins un facteur de confusion important : les personnes des personnes plus éduquées auront à la fois une meilleure santé et une tendance à se déplacer à vélo (électrique), pour des raisons écologiques par exemple. Elles sont plus susceptibles également d'être dans des conditions permetant l'utilisation du vélo pour se rendre à leur travail (centre ville)"
    },
    {
        id: 10,
